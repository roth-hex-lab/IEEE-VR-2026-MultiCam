...
int main() {
  // Directories
  std::filesystem::path model_directory{"path/to/checkpoint_multicam"};
  std::filesystem::path dataset_directory{"path/to/dataset/multiview"};
  std::filesystem::path external_directory{"path/to/dataset/multiview/external"};
  std::filesystem::path result_path{"path/to/dataset/multiview/result"};
  ...
  // Run experiments
  Scenertm6dEvaluator evaluator{num_view, "evaluator", model_directory, dataset_directory,
