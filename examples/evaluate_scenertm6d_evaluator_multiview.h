 ...
 */
class Scenertm6dEvaluator {
 private:
  static constexpr size_t kNCurveValues = 100;
  static constexpr float kThresholdMax = 0.1f;
  static constexpr m3t::Intrinsics KinectcolorIntrinsics0{
      630.4642f, 630.3013f, 641.1418f, 366.7988f, 1280, 720};
  static constexpr m3t::Intrinsics KinectdepthIntrinsics0{
      504.2108f, 504.3045f, 327.5446f, 340.1757f, 640, 576};
  static constexpr m3t::Intrinsics KinectcolorIntrinsics1{
      637.7629f, 637.5334f, 642.5089f, 366.6436f, 1280, 720};
  static constexpr m3t::Intrinsics KinectdepthIntrinsics1{
      504.9359f, 505.0717f, 327.6832f, 327.7154f, 640, 576
  };
  std::vector<m3t::Intrinsics> KinectcolorIntrinsics{
      KinectcolorIntrinsics0, KinectcolorIntrinsics1};
  std::vector<m3t::Intrinsics> KinectdepthIntrinsics{KinectdepthIntrinsics0,
                                                     KinectdepthIntrinsics1};
  static constexpr m3t::Intrinsics HololensIntrinsics{
      987.104f, 987.267f, 624.957f, 341.757f, 1280, 720};
 ...
 private:
  ...
  void UpdateCameras(int load_index) const;
  ...
  std::shared_ptr<m3t::LoaderColorCamera> hololens_color_ptr;
  std::vector<std::shared_ptr<m3t::LoaderColorCamera>> color_camera_ptrs{};
  std::vector<std::shared_ptr<m3t::LoaderDepthCamera>> depth_camera_ptrs{};
  ...
  std::vector<m3t::Intrinsics> hololens_intrinsics;
  ...
  m3t::Transform3fA depth2color0, depth2color1;
  std::vector<m3t::Transform3fA> depth2colors;
